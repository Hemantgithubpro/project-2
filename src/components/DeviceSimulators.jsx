...
export function DeviceSimulators({ state }) {
  ...
  const [deviceTab, setDeviceTab] = useState('push');
            ...
            <div className="phone-screen">
              {pushList.length === 0 ? (
                <div style={{
                  ...
                  <Bell
                    className="w-8 h-8"
                    style={{ margin: '0 auto 0.5rem auto', opacity: 0.3 }}
                  />
                  <div>No Push Notifications Yet</div>
                  <div style={{ fontSize: '0.7rem', marginTop: '0.2rem' }}>
                    Dispatch a push notification to see it arrive here.
                  </div>
                </div>
              ) : (
                pushList.map(msg => (
                ...
                emailList.map(msg => (
                  <div
                    ...
                    style={{
                      ...
                      cursor: 'pointer',
                      background: (selectedEmail && selectedEmail.id === msg.id)
              ...
              {selectedEmail ? (
                <div>
                  ...
                  <div style={{
                    ...
                    <div>
                      <div>From: <strong>EventSignal &lt;noreply@eventsignal.io&gt;</strong></div>
                  ...
                  <div style={{
                    ...
                    <div style={{ fontSize: '0.725rem', color: 'var(--text-muted)' }}>
                      Delivered via SendGrid SMTP (Latency: 42ms).<br />
